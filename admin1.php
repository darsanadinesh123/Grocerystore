...
<!-- /banner section -->
  ...
  <tr>
    <td bgcolor="#FFFFFF"><div align="center"> <br>
        ...
        <tr>
          <td class="newtext" bgcolor="#FFFFFF"><div align="left"><img src="images/arrow_white.gif" border="0" height="8" width="7">&nbsp;<a href="checkaddcourier.php" class="REDLink">List Officer</a></div></td>
        </tr>
                <tr>
          <td class="newtext" bgcolor="#FFFFFF"><div align="left"><img src="images/arrow_white.gif" border="0" height="8" width="7">&nbsp;<a href="courier-list.php" class="REDLink">List Branch</a></div></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="newtext" bgcolor="#FFFFFF"><div align="left"><img src="images/arrow_white.gif" border="0" height="8" width="7">&nbsp;<a href="logout.php" class="REDLink">Logout</a></div></td>
        </tr>
      </tbody></table>
            <br>
          <br>
