...
$a=$_POST["trackcode"];
$s=mysqli_query($con,"select * from tbl_statusupdate where consignmentno='$a'");
...
<th class='newtext'>Consignment No. </th><th class='newtext'>Status Updated On</th><th class='newtext'>Current Status</th></tr>";
  ...
  {
	  $cid=$row[0];
  echo"<tr> <a href='statusview.php'></td>
  <td width='7%'>$row[1]</td><td width='11%'>$row[2]</td><td width='11%'>$row[3]</td>
  </tr>";	 
  }
