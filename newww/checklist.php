...
<tr><th class='newtext'>Edit </th><th class='newtext'>Shipper</th><th class='newtext'>Receiver</th><th class='newtext'>Consignment no</th><th class='newtext'>Pckup Date</th><th class='newtext'>Status</th></tr>";
  ...
  echo"<tr><td width='6%' class='newtext'> <a href='statusupdate.php'> <img src='images/edit_icon.gif' border='0' height='20' width='20'>Edit </th> </td>
  <td width='7%'>$row[1]</td><td width='11%'>$row[7]</td><td width='11%'>$row[0]</td><td width='11%'>$row[21]</td><td width='9%'>$row[23]</td>
  <td width='7%'><form method='post' action='checklistdelete.php'><input type='hidden' name='h1' value='$consignmentno'><input type='submit' name='delete' value='Delete'> </form> </tr>";	 
  }
