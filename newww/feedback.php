...
<html>
<head>
<title>Courier Store A Corporate Business Bootstrap Responsive Website Template | Contact :: w3layouts</title>
<!-- for-mobile-apps -->
				...
				<li class="dropdown">
					...
					<div class="dropdown-menu">
						<div class="track-w3ls">
							...
							<form action="statusview.html" method="post">
...
<section class="contact-w3ls">
	<div class="container">
		...
		<p class="text-center">Your Feedbacks Are Valuable To Us.</p>	
			...
			<form method="post" name="sentMessage" id="contactForm" >
				...
				<div class="control-group form-group">
                        <div class="controls">
                            <label class="contact-p1">How do you rate our website overall?</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
							Bad<input type="radio"  name="radio" id="email" required value="Bad">
							Average<input type="radio" name="radio" id="email" required value="Average">
							Good<input type="radio" name="radio" id="email" required value="Good">
							Very good<input type="radio" name="radio" id="email" required value="Very good">	
							Excellent<input type="radio" name="radio" id="email" required value="excellent">
							</div>
							 <div class="controls">
                            <label class="contact-p1">How do you rate design of our website?</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
							Bad<input type="radio"  name="radio1" id="email" required value="Bad">
							Average<input type="radio" name="radio1" id="email" required value="Average">
							Good<input type="radio" name="radio1" id="email" required value="Good">
							Very good<input type="radio" name="radio1" id="email" required value="Very good">	
							Excellent<input type="radio" name="radio1" id="email" required value="excellent">
							</div>
							 <div class="controls">
                            <label class="contact-p1">How is our service?</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
							Bad<input type="radio"  name="radio2" id="email" required value="Bad">
							Average<input type="radio" name="radio2" id="email" required value="Average">
							Good<input type="radio" name="radio2" id="email" required value="Good">
							Very good<input type="radio" name="radio2" id="email" required value="Very good">	
							Excellent<input type="radio" name="radio2" id="email" required value="excellent">
							</div>
							 <div class="controls">
                            <label class="contact-p1">Is informatiopn provide on our website enough?</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
							Yes<input type="radio"  name="radio3" id="email" required value="Yes">
							No<input type="radio" name="radio3" id="email" required value="No">
							
							</div>
							 <div class="controls">
                            <label class="contact-p1">Is our website user friendly?</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
							Yes<input type="radio"  name="radio4" id="email" required value="Yes">
							No<input type="radio" name="radio4" id="email" required value="No">
							
							</div>
							</div>
                    <div class="control-group form-group">
                        <div class="controls">
                            <label class="contact-p1">Any suggestion?</label>
                    ...
                    <button type="submit" class="btn btn-primary" name="btnsubmit" value="Send Feedback">Send Feedback</button>
				</div>
...
$con= mysqli_connect("localhost","root","","newdb");
		...
		
	{
		//echo "hi";
			...
			$g=$_POST["radio4"];
			$i=$_POST["message"];
			$sql="INSERT INTO tbl_feedback(name, phone, email, rate_web, rate_design, service, inftn_enough, user_frndly, suggestion) VALUES('$a','$b','$h','$c','$d','$e','$f','$g','$i')";
