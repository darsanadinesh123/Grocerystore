    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-truck" aria-hidden="true"></i>Insurance & Tariff<b class="caret"></b></a>
					<div class="dropdown-menu">
					<form action="insurance.php" method="post">
					<ul>
					<li><a href="insureuser.php">Insurance</a></li>
					<li><a href="frame.php">Details</a></li>
					</li>
					</ul>
					</form>
					</div>
...
<!-- /banner section -->
  ...
  <tr>
    <td bgcolor="#FFFFFF"><div align="center"> <br>
        <br>
        <table bgcolor="#ECECEC" border="1" cellpadding="2" cellspacing="2" align="center" width="50%">
        <tbody><tr>
          <td class="Partext1" bgcolor="#EEEEEE"><div align="left"><strong> OFFERS 2 INSURANCE PLANS </strong></div></td>
        </tr>
		

<tr><td>
Whole Life Assurance  (SURAKSHA)</td></tr>	
<tr>
<td >Convertible Whole Life Assurance (SUVIDHA)</td>		
 </tr>	 
      </tbody></table>
            <br>
          <br>
...
<br>
 <table>
  <tr>
  <td>
 <b><u> CONVERTIBLE WHOLE LIFE ASSURANCE: </b></u>
