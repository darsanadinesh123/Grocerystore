        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="process.html">Process</a></li>
												<li><a href="process.html">Consignment</a></li>
...
$s=mysqli_query($con,"SELECT `consignmentno`, `statusdate`, `newstatus` FROM `tbl_statusupdate` WHERE consignmentno=$s'");
echo "<table border ='3' cellspacing='3' cellpadding='3' align='center'>
<tr><th colspan=12><font size=15 color=white >Status List</font></th></tr>
<tr><th>Consignment no</th><th>Pickup Date</th><th>Status</th></tr>";
  while($row=mysqli_fetch_array($s))
  {
	  $cid=$row[0];
  echo"<tr><td>$row[6]</td><td>$row[16]</td><td>$row[18]</td></tr>";	 
   }
  echo"</table>"
