...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="900">
  ...
  <tr>
    <td bgcolor="#FFFFFF"><table border="0" cellpadding="1" cellspacing="1" align="center" width="98%">
      ...
      <tr>
        <td><div align="center">
           <form name="signupForm" id="signupForm" method="post" action="index.php" onSubmit="return Check_form();"> 
                    ...
                    <tr>
                      <td height="18"><table class="newtext" border="0" cellpadding="2" cellspacing="2" align="center" width="100%">
                        <tbody><tr>
						 ...
						 <tr>
                          <td width="40%"><div align="right">Old Password  : </div></td>
                          <td width="60%"><div align="left">
                              <input name="txtoldpass" id="txtp1" type="password">
                          </div></td>
                        </tr>
                        <tr>
                          <td width="40%"><div align="right">New Password  : </div></td>
                          <td width="60%"><div align="left">
                              <input name="txtnewpass" id="txtp2" type="password">
                          </div></td>
                        </tr>
                        <tr>
                          <td><div align="right">Confirm Password : </div></td>
                          <td><div align="left">
                              <input name="txtretypepass" id="txtcp" type="password">
                          </div></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
...
$con= mysqli_connect("localhost","root","","newdb");
	...
	
	{
		$c=$_POST["password"];
			...
			$sql="UPDATE `login` SET `password`='$a' WHERE email=`maill`";
...
if(isset ($_POST["Submit"]))
{
	    ...
	    $s3=$_POST["txtretypepass"];
			  ...
			  $s=mysqli_query($con,"select * from login where password='$s1'");
			  $a=0;
