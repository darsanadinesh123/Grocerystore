                        ...
                        <tbody><tr>
						 ...
						 <tr>
                          ...
                          <td width="60%"><div align="left">
                              <input name="txtoldpass" id="txtp" type="password">
                          </div></td>
                        </tr>
                        <tr>
                          <td width="40%"><div align="right">New Password  : </div></td>
                          <td width="60%"><div align="left">
                              <input name="txtnewpass" id="txtp" type="password">
                          </div></td>
                        </tr>
                        <tr>
...
<?php
	    ...
	    $s3=$_POST["txtretypepass"];
			  ...
			  $s=mysqli_query($con,"select * from login1 where pass='$s1'");
			  $a=0;
