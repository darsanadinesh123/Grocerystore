...
$con= mysqli_connect("localhost","root","","newdb");
			...
			$u=$_POST["Comments"];
			//echo $c."<br/>";
			$sq="INSERT INTO tbl_checkaddcour(shippername, phone, address, fbranch, fcontry, fstate, receivername, rphone, raddress, rbranch, rcontry, rstate, ctype, typeship, weight, qnty, bookingmode, freight, waymode, depttime, pickdate, picktime, status, comments) VALUES('$a','$b','$c','$v','$w','$x','$d','$e','$f','$va','$wa','$xa','$h','$g','$i','$k','$n','$o','$p','$r','$t','$q','$u')";
			mysqli_query($con,$sq);
  ...
  <head></head>
  <body>
  <form  method="post" name="frmShipment" action="" > 
